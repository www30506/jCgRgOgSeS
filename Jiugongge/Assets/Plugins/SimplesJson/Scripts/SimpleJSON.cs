...
namespace I2.Loc.SimpleJSON
{
	...
	public class JSONNode
	{
		...
		public JSONNode Find(string key1, string key2=null, string key3=null, string key4=null){
			JSONNode n = this [key1];
			if ( n!=null && key2!=null) {
				n = n [key2];
				if ( n!=null && key3!=null) {
					n = n [key3];
	...
	{
		public static JSONNode Parse(string aJSON, string childObjectName = null)
		{
			JSONNode n = JSONNode.Parse (aJSON);
			if (n != null && childObjectName != null) {
				n = n [childObjectName];
			}
			return n;
		}
